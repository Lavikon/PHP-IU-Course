<?php
$dropm = "DROP TABLE IF EXISTS php2022niko_movies";

$createm = "CREATE TABLE php2022niko_movies (
...
$datam = "INSERT INTO php2022niko_movies (title, rating, year, link, director, stars)
VALUES
